/*
  Feather_ESP32_S3_TFT_MQTT_multi_topic_v2.ino
  ...
  "head": {"ow": "Feath", "de": "Lab", "dc": "BME280", "sc": "meas", "vt": "f", "ts": 1755622875},
...
int composePayload(char* outBuffer, size_t outSize,
  ...
  header["t"] = mqttMsgID;  //  global var mqttMsgID is an unsigned long (takes 10 bytes while a human-readable full datetime = 19bytes)
