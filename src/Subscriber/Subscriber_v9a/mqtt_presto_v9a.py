    ...
    if mode == 0:
        ...
        try:
            ...
            if topic_idx == 0: # sensors/Feath/ambient
                ...
                if n1 >= 0 and n2 >= 0:
                    vector.text(t1, x, y) #, WIDTH, scale = my_scale)
                    y += line_space + 5
                    vector.text(t2, x, y) #, WIDTH, scale = my_scale)
                    y += line_space + 5
                    vector.text(t3, x, y) #, WIDTH, scale = my_scale)
                    if not my_debug:
                        print(TAG+f"{t1}")
                        print(TAG+f"{t2}")
                        print(TAG+f"{t3}")
                    ...
                    vector.text(wx_metar_txt_draw) #, x, y, WIDTH, scale = my_scale)
                    if not my_debug:
