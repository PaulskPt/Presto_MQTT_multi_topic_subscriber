...
# tcp_targeta['0'] = secrets['lan']['0'] # {'ip': '192.168.1.__', 'name': 'presto', 'timeout': '1.0'}}  Pimoroni Presto - MQTT Subscriber1
# tcp_targeta['1'] = secrets['lan']['1'] # {...} Pimoroni Pico Plus 2W nr1 - TCP Listener
# tcp_targeta['2'] = secrets['lan']['2'] # {...} iLabs RPICO32 - TCP Listener
# tcp_targeta['3'] = secrets['lan']['3'] # {...} Raspberry Pi Compute Module 5 - MQTT Broker - TCP Listener
# tcp_targeta['4'] = secrets['lan']['4'] # {...} Raspberry Pi 4B-4GB with RP senseHat V2
